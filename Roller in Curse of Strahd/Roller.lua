...
--Pink
ref_diceCustom = {
    {url="http://i.imgur.com/JmgpO7P.jpg", name="", sides=4},  --Default: d4
    {url="http://i.imgur.com/UslRnev.jpg", name="", sides=6},  --Default: d6
    {url="http://i.imgur.com/V8Dt7cA.jpg", name="", sides=8},  --Default: d8
    {url="http://i.imgur.com/LwAPOri.jpg", name="", sides=10}, --Default: d10
...
--Blue
ref_diceCustom = {
    {url="http://i.imgur.com/n9Pxlff.jpg", name="", sides=4},  --Default: d4
    {url="http://i.imgur.com/dKmSIp1.jpg", name="", sides=6},  --Default: d6
    {url="http://i.imgur.com/fqiRKWU.jpg", name="", sides=8},  --Default: d8
    {url="http://i.imgur.com/ItQuuTR.jpg", name="", sides=10}, --Default: d10
    {url="http://i.imgur.com/jaw2Ois.jpg", name="", sides=12}, --Default: d12
    {url="http://i.imgur.com/3MbfRJd.jpg", name="Toothy 20", sides=20}, --Default: d20
}
...
function rollStandard(player, clickButton, id)
    rollDice(player.color, "standard")
end

function rollAdvantage(player)
    rollDice(player.color, "advantage")
end

function rollDisadvantage(player)
    rollDice(player.color, "disadvantage")
end

--Rolls all the dice and then launches monitoring
function rollDice(color, rollStyle)
